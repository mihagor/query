...
--,datx.DATE_SID	
--	,TO_NUMBER(SUBSTR(T.ACCOUNTING_DATE_SID, 0, 6) || '01') AS ACCOUNTING_DATE_SID
--	,datx.DATE_SID AS ACCOUNTING_DATE_SID	
...
-- testing
AND  MONTH(DATE(DATx.DATE)) = 3  
and  PROFIT_CENTER_EXT_REFR = '2410|PIS'
--and T.ACCOUNTING_DATE_SID = 20190301
-- floor(t.ACCOUNTING_DATE_SID / 10000) in ( year(current_date) - 1)  and month(current_date) <> month(date(dat.date))
...
GROUP BY
        ...
        ,CO.NAME 
--,datx.DATE_SID        
--        ,TO_NUMBER(SUBSTR(T.ACCOUNTING_DATE_SID, 0, 6) || '01')
