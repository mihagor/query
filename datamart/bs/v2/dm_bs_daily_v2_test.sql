...
--popravek 7.4. AND MONTH(CURRENT_DATE) = substr(T.accounting_date_sid, 5, 2)
...
from    daily d
left join attributes a  on a.profit_center_ext_refr = (case when d.PC_L7 = 'N/A' and d.PC_L6 = 'N/A' and d.PC_L5 = 'N/A'        then d.PC_LEVEL04_EXT_REFR
                                                       when d.PC_L7 = 'N/A' and d.PC_L6 = 'N/A'                                 then d.PC_LEVEL05_EXT_REFR 
                                                       when d.PC_L7 = 'N/A'                                                     then d.PC_LEVEL06_EXT_REFR 
                                                       else d.PC_LEVEL07_EXT_REFR
                                                       end)		
...
select  
--        to_char(accounting_date, 'yyyymm') as accounting_date,
        company_code_pis,
        company_code,    
        company_name,    
        pc_l1, pc_l1_name,
...
from    temp
where   1 = 1  
and     accounting_date_sid between 20200401 and 20200407
and     is_own_usage = 0 
