...
,sum(nvl(A.SALES_LINE_QTY, 0))
,sum(nvl(A.PURCHASE_PRICE_AMAP_LINE_AMT, 0))
,sum(nvl(A.NET_SALES_SAP_LINE_AMT,0) + nvl(MARGIN_DISCOUNT_LINE_AMT,0))  marza -- èista marža za primrjavo s copa only  + MARGIN_DISCOUNT_LINE_AMT
