...
--        p.level05_code, p.level05_name,  
--        p.level06_code, p.level06_name,     
...
where   accounting_date_sid between 20200501 and 20200531
and     f.is_own_usage = 0
--and     p.level01_code <> ('06')
--and     p.level02_code = '02'
--and     p.level04_code = '3418|GR'
and     pc.level03_code in ('4803') --,  '4802',
--and     pc.level05_code = '5547'
--and     (pca.attribute_name in ('INŠTRUKTORJI BiH') or pca.attribute_name is null) --'BS GEOGRAFSKO', 'LOKACIJA BS', 
