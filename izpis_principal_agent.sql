...
from    f_sales_all_monthly               f             
--        inner join d_date                 d         on f.accounting_yearmonth_id = d.month_id
...
where   1 = 1
and     f.accounting_yearmonth_id between 201901 and 202007                                     
--and     f.is_own_usage = 0
and     pr.level01_code <> ('06')
and     pr.level01_code = ('03')
...
--and     mp_code <> 'N/A'
and      (pr.level02_code = '0305' and pr.level03_code <> 'N/A')
and
